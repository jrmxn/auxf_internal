...
%https://github.com/wme7/aero-matlab/blob/master/setupEditorColors.m
%% Setup the color pallet

% divide by 256 for Matlab
sol.base03  = [ 40  40  40] / 256; % main background colour
sol.base02  = [  3  54  66] / 256; %the colour when you have a selected line
...
str  = sol.orange;    % Set 'Strings' color
